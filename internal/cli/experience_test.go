...
func experienceFakeAPI(t *testing.T) *httptest.Server {
	...
	mux.HandleFunc("/api/v1/me/experience", func(w http.ResponseWriter, _ *http.Request) {
		w.Write([]byte(`{"data":{"employments":[{"id":"11111111-1111-4111-8111-111111111111","kind":"job","company":"RingCentral","role":"SWE","start":"Mar 2021","atoms":[]}],"unplaced":[{"id":"22222222-2222-4222-8222-222222222222","claim":"Cut latency 20s to 1s","context":"the checkout path","metrics":["20s->1s"],"skills":["go","kubernetes"],"provenance":"manual"}]}}`))
	})
